...
This script runs the BAU and MIT scenarios through ECOMOD. We run strategies with 'actual' and 'estimated' yields to deal with crops not included in ECOMOD. Ensure the soil variable has two decimal places or ECOMOD won't run.  
