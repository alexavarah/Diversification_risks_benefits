...
This script re-runs the BAU scenario through ECOMOD. It also runs MIT as I need the output files so I can calculate the difference between BAU and MIT.  
...
## (l.i)   Run ECOMOD, low density, yield = "estimate" ----
