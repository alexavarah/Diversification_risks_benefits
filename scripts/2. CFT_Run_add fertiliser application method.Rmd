...
lookup$DestCol =               c( NA, NA, "e", NA,  NA, "e","e","e","e","e","e","e", NA, "e","e","e", NA,               "e","e","g","i","e","e","e","f","g","e","e","e","e","e","e","e","e","e","e","e","e","e","e","e","e") 
lookup$DestSheet = as.numeric(c(  NA, NA,  2,  NA,  NA,  2,  2,  2,  2,  2,  3,  3,  NA,  3,  3,  3,  NA,  
 3,  3,  3,  3,  6,  3,  4,  4,  4,  3,  4,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6))
lookup$DestRow =   as.numeric(c(  NA, NA,  6,  NA,  NA, 11, 12, 14, 17, 18,  5, 12,  NA, 13, 14, 15,  NA, 
16, 19, 19, 19, 61, 27, 12, 12, 12, 31, 16, 36, 38, 39, 41, 42, 43, 53, 46, 49, 50, 51, 54, 56, 60))
...
run_CFT <- function(DF, subtract = "nothing"){
  ...
  output <- setNames(output, c("Field ID", 
                               ...
                               "Field N20 from fertiliser (kgC02eq/ha)", #Direct and indirect field N20 from fertiliser
                               "Pesticide (kgC02eq/ha)", 
                               "C stock changes (kgC02eq/ha)", 
                               "Field energy use (kgC02eq/ha)", 
