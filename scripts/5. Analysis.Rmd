...
## 3.4. Mean difference in C emissions per initDR - find difference for each year, take mean across rotation
...
## 3.5. Mean difference in C emissions per initDR - sum over rotation, find difference
